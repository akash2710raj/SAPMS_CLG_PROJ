				 ...
				 <jsp:include page="scroll.html"/> 
                   ...
                   <td width="412" valign="top">
                    <table width="200" border="0" align="center">
                  	...
                  	<table width="500" border="1" align="center" bordercolor="" bgcolor="">
                      <tr>
                        <td width="123" bgcolor="skyblue"><div align="center" class="style15">Company Name </div></td>
                        <td width="123" bgcolor="skyblue"><div align="center" class="style15">Vacancy Position</div></td>
                        <td width="80" bgcolor="skyblue"><div align="center" class="style15">Experience</div></td>
                      ...
                      <%
                       ...
                       %>
                      <tr>
                        <td bgcolor=""><a href="viewvacancydetails.jsp?vacancyid=<%=vacancyid%>" class="style12"><%=vacancydto.getCompanyname() %></a></td>
                        <td bgcolor=""><span class="style12"><%=vacancydto.getVacancyposition() %></span></td>
                        <td bgcolor=""><span class="style12"><%=vacancydto.getDesiredexp()%></span></td>
                        <td bgcolor=""><span class="style12"><%=DateWrapper.parseDate(vacancydto.getExpirydate1())%></span></td>
                      </tr>
                      <%} %>
                    </table>
