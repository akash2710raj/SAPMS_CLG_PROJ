                  ...
                  <td width="412" valign="top">
                    ...
                    <table width="200" border="0" align="center">
                      ...
                      <%
                       ...
                       %>
                      <tr>
                        <td ><p class="style12" onClick="javascript:path='viewuserfrienddetails.jsp?loginname=<%=name%>' 
hwnd = window.open(path,'profile','width=600,height=400,scrollbars=yes,resizable=no,toolbar=no,location=no,status=no,menubar=no' );"><%=frienddto.getLoginame()%>&nbsp;<%=frienddto.getLastname()%> </p></td>
                        <td ><span class="style12"><%=DateWrapper.parseDate(frienddto.getBirdthdate1())%></span></td>
                        <td ><span class="style12"><%=frienddto.getProfession()%></span></td>
                        <%
                          if(session.getAttribute("user")!=null)
                          {
                         %>
                        <td ><span class="style12"><a href="Compose.jsp?loginname=<%=name%>">Send message</a></span></td>
                        <%} %>
                      </tr>
                      <%} %>
                    </table>
